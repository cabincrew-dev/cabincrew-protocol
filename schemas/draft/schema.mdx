...
| `workflow_state` | `string` | No | Workflow state when this event was emitted. REQUIRED for temporal chain-of-custody reconstruction. |
...
| Property | Type | Required | Description |
|---|---|---|---|
| `decision` | `string` | Yes | Final aggregated decision after all policy evaluations. REQUIRED for chain-of-custody. |
